...
const APIName = "petstore-test-" + APIVersion
...
const SampleHttpRouteConfig = "testdata/SampleHttpRouteConfig.yaml"
const SampleConfigMap = "testdata/SampleConfigMap.yaml"
